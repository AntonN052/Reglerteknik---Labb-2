...
frekvens_nr = 2; %% ändra för att studera olika frekvenser
...
w_c = 1.45;
w_list = [0.2, 0.39, 0.75, 1.05,w_c, 2.83, 5.50, 8.0];
belopp_list = [11.0712, 5.3528, 2.4494, 1.5260, 0.9812, 0.2689, 0.0695, 0.0316 ]; %uppmätta belopp
fas_list = [-104.821, -111.667, -128.571, -139.500, -150.755, -166.591, -178.583, -185.038] .* pi / 180;    %uppmätta fasförskjutningar
